			...
			<li class="nav-item navbar-dropdown dropdown-user dropdown"><a
				...
				href="javascript:void(0);" data-bs-toggle="dropdown">
					<div class="avatar avatar-online">
						<img src="https://chungculuxuryparkviews.com/wp-content/uploads/2022/10/anh-avatar-dep-cho-con-gai-ngau-9.jpg" alt
					...
					<li><a class="dropdown-item" href="#">
							<div class="d-flex">
								...
								<div class="flex-grow-1">
									<span class="fw-semibold d-block"></span> <small
