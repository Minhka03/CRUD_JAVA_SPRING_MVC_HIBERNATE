                                    ...
                                    <div class="img-large-slider common-slider" data-slick='{
                                        ...
                                        <div class="img-large-wrapper">
                                            <a href="assets/img/products/bags/38.jpg" data-fancybox="gallery">
                                                <img src="${pageContext.servletContext.contextPath}/resources/assets/img/products/bags/38.jpg" alt="img">
                                            </a>
                                        </div>
                                        <div class="img-large-wrapper">
                                            <a href="/assets/img/products/bags/37.jpg" data-fancybox="gallery">
                                                <img src="${pageContext.servletContext.contextPath}/resources/assets/img/products/bags/37.jpg" alt="img">
                                            </a>
                                        </div>
                                        <div class="img-large-wrapper">
                                            <a href="/assets/img/products/bags/36.jpg" data-fancybox="gallery">
                                                <img src="${pageContext.servletContext.contextPath}/resources/assets/img/products/bags/36.jpg" alt="img">
                                            </a>
                                        </div>
                                        <div class="img-large-wrapper">
                                            <a href="/resources/assets/img/products/bags/34.jpg" data-fancybox="gallery">
                                                <img src="${pageContext.servletContext.contextPath}/resources/assets/img/products/bags/34.jpg" alt="img">
                                            </a>
                                        </div>
                                        <div class="img-large-wrapper">
                                            <a href="/assets/img/products/bags/30.jpg" data-fancybox="gallery">
                                                <img src="${pageContext.servletContext.contextPath}/resources/assets/img/products/bags/30.jpg" alt="img">
                                            </a>
                                        </div>
                                        <div class="img-large-wrapper">
                                            <a href="/assets/img/products/bags/32.jpg" data-fancybox="gallery">
                                                <img src="${pageContext.servletContext.contextPath}/resources/assets/img/products/bags/32.jpg" alt="img">
                                            </a>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="product-details ps-lg-4">
                                ...
                                <div class="misc d-flex align-items-end justify-content-between mt-4">
                                    <div class="quantity d-flex align-items-center justify-content-between">
                                        <button class="qty-btn dec-qty"><img src="${pageContext.servletContext.contextPath}/resources/assets/img/icon/minus.svg" alt="minus"></button>
                                        <input class="qty-input" type="number" name="qty" value="1" min="0">
                                        <button class="qty-btn inc-qty"><img src="${pageContext.servletContext.contextPath}/resources/assets/img/icon/plus.svg" alt="plus"></button>
                                    </div>
                        ...
                        <div id="pdescription" class="tab-pane fade show active">
                            <div class="row">
                                ...
                                <div class="col-lg-5 col-md-12 col-12">
                                    <div class="desc-img">
                                        <img src="${pageContext.servletContext.contextPath}/resources/assets/img/product.jpg" alt="img">
                                    </div>
                                </div>
                ...
                <div class="container">
                        ...
                        <div class="product-card">
                            <div class="product-card-img">
                                <a class="hover-switch" href="collection-left-sidebar.html">
                                    <img class="secondary-img" src="${pageContext.servletContext.contextPath}/resources/assets/img/products/bags/11.jpg"
                                        alt="product-img">
                                    <img class="primary-img" src="${pageContext.servletContext.contextPath}/resources/assets/img/products/bags/1.jpg"
                                        alt="product-img">
                                </a>
                    ...
                    <div class="new-item" data-aos="fade-up" data-aos-duration="300">
                        <div class="product-card">
                            <div class="product-card-img">
                                <a class="hover-switch" href="collection-left-sidebar.html">
                                    <img class="secondary-img" src="${pageContext.servletContext.contextPath}/resources/assets/img/products/bags/22.jpg"
                                        alt="product-img">
                                    <img class="primary-img" src="${pageContext.servletContext.contextPath}/resources/assets/img/products/bags/2.jpg"
                                        alt="product-img">
                                </a>
                    ...
                    <div class="new-item" data-aos="fade-up" data-aos-duration="300">
                        <div class="product-card">
                            <div class="product-card-img">
                                <a class="hover-switch" href="collection-left-sidebar.html">
                                    <img class="secondary-img" src="${pageContext.servletContext.contextPath}/resources/assets/img/products/bags/23.jpg"
                                        alt="product-img">
                                    <img class="primary-img" src="${pageContext.servletContext.contextPath}/resources/assets/img/products/bags/3.jpg"
                                        alt="product-img">
                                </a>
                    ...
                    <div class="new-item" data-aos="fade-up" data-aos-duration="300">
                        <div class="product-card">
                            <div class="product-card-img">
                                <a class="hover-switch" href="collection-left-sidebar.html">
                                    <img class="secondary-img" src="${pageContext.servletContext.contextPath}/resources/assets/img/products/bags/26.jpg"
                                        alt="product-img">
                                    <img class="primary-img" src="${pageContext.servletContext.contextPath}/resources/assets/img/products/bags/4.jpg"
                                        alt="product-img">
                                </a>
                    ...
                    <div class="new-item" data-aos="fade-up" data-aos-duration="300">
                        <div class="product-card">
                            <div class="product-card-img">
                                <a class="hover-switch" href="collection-left-sidebar.html">
                                    <img class="secondary-img" src="${pageContext.servletContext.contextPath}/resources/assets/img/products/bags/27.jpg"
                                        alt="product-img">
                                    <img class="primary-img" src="${pageContext.servletContext.contextPath}/resources/assets/img/products/bags/5.jpg"
                                        alt="product-img">
                                </a>
                    ...
                    <div class="new-item" data-aos="fade-up" data-aos-duration="300">
                        <div class="product-card">
                            <div class="product-card-img">
                                <a class="hover-switch" href="collection-left-sidebar.html">
                                    <img class="secondary-img" src="${pageContext.servletContext.contextPath}/resources/assets/img/products/bags/29.jpg"
                                        alt="product-img">
                                    <img class="primary-img" src="${pageContext.servletContext.contextPath}/resources/assets/img/products/bags/6.jpg"
                                        alt="product-img">
                                </a>
                    ...
                    <div class="new-item" data-aos="fade-up" data-aos-duration="300">
                        <div class="product-card">
                            <div class="product-card-img">
                                <a class="hover-switch" href="collection-left-sidebar.html">
                                    <img class="secondary-img" src="${pageContext.servletContext.contextPath}/resources/assets/img/products/bags/17.jpg"
                                        alt="product-img">
                                    <img class="primary-img" src="${pageContext.servletContext.contextPath}/resources/assets/img/products/bags/7.jpg"
                                        alt="product-img">
                                </a>
                    ...
                    <div class="new-item" data-aos="fade-up" data-aos-duration="300">
                        <div class="product-card">
                            <div class="product-card-img">
                                <a class="hover-switch" href="collection-left-sidebar.html">
                                    <img class="secondary-img" src="${pageContext.servletContext.contextPath}/resources/assets/img/products/bags/18.jpg"
                                        alt="product-img">
                                    <img class="primary-img" src="${pageContext.servletContext.contextPath}/resources/assets/img/products/bags/8.jpg"
                                        alt="product-img">
                                </a>
                    ...
                    <ul class="utility-menu list-unstyled">
                        ...
                        <li class="utilty-menu-item">
                            <button type="button" class="currency-btn btn-reset" data-bs-toggle="dropdown"
                                aria-expanded="false">
                                <img class="flag" src="${pageContext.servletContext.contextPath}/resources/assets/img/flag/usd.jpg" alt="img">
                                <span>USD</span>
                                <span class="utilty-icon-wrapper">
                                    <svg class="icon icon-dropdown" xmlns="http://www.w3.org/2000/svg" width="24"
                            ...
                            <ul class="currency-list dropdown-menu dropdown-menu-end px-2">
                                ...
                                <li class="currency-list-item ">
                                    <a class="currency-list-option" href="#" data-value="CAD">
                                        <img class="flag" src="${pageContext.servletContext.contextPath}/resources/assets/img/flag/cad.jpg" alt="img">
                                        <span>CAD</span>
                                    </a>
                                </li>
                                <li class="currency-list-item ">
                                    <a class="currency-list-option" href="#" data-value="EUR">
                                        <img class="flag" src="${pageContext.servletContext.contextPath}/resources/assets/img/flag/eur.jpg" alt="img">
                                        <span>EUR</span>
                                    </a>
                                </li>
                                <li class="currency-list-item ">
                                    <a class="currency-list-option" href="#" data-value="JPY">
                                        <img class="flag" src="${pageContext.servletContext.contextPath}/resources/assets/img/flag/jpy.jpg" alt="img">
                                        <span>JPY</span>
                                    </a>
                                </li>
                                <li class="currency-list-item ">
                                    <a class="currency-list-option" href="#" data-value="GBP">
                                        <img class="flag" src="${pageContext.servletContext.contextPath}/resources/assets/img/flag/gbp.jpg" alt="img">
                                        <span>GBP</span>
                                    </a>
                                </li>
                            </ul>
                    ...
                    <div class="minicart-loop custom-scrollbar">
                        ...
                        <div class="minicart-item d-flex">
                            <div class="mini-img-wrapper">
                                <img class="mini-img" src="${pageContext.servletContext.contextPath}/resources/assets/img/products/furniture/1.jpg" alt="img">
                            </div>
                        ...
                        <div class="minicart-item d-flex">
                            <div class="mini-img-wrapper">
                                <img class="mini-img" src="${pageContext.servletContext.contextPath}/resources/assets/img/products/furniture/2.jpg" alt="img">
                            </div>
                            <div class="product-info">
                        ...
                        <div class="minicart-item d-flex">
                            <div class="mini-img-wrapper">
                                <img class="mini-img" src="${pageContext.servletContext.contextPath}/resources/assets/img/products/furniture/3.jpg" alt="img">
                            </div>
                            <div class="product-info">
                        ...
                        <div class="minicart-item d-flex">
                            <div class="mini-img-wrapper">
                                <img class="mini-img" src="${pageContext.servletContext.contextPath}/resources/assets/img/products/furniture/4.jpg" alt="img">
                            </div>
                            <div class="product-info">
                                <h2 class="product-title"><a href="#">Vita Lounge Chair</a></h2>
                                <p class="product-vendor">XS / Dove Gray</p>
