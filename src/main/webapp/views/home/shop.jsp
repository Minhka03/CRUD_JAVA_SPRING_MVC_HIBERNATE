                                        ...
                                        <div class="product-card">
                                            <div class="product-card-img">
                                                <a class="hover-switch" href="collection-left-sidebar.html">
                                                    <img class="secondary-img" src="${pageContext.servletContext.contextPath}/resources/assets/img/products/furniture/9.jpg"
                                                        alt="product-img">
                                                    <img class="primary-img" src="${pageContext.servletContext.contextPath}/resources/assets/img/products/furniture/1.jpg"
                                                        alt="product-img">
                                                </a>
                                            ...
                                            <div class="product-card-img">
                                                <a class="hover-switch" href="collection-left-sidebar.html">
                                                    <img class="secondary-img"
                                                        src="${pageContext.servletContext.contextPath}/resources/assets/img/products/furniture/10.jpg" alt="product-img">
                                                    <img class="primary-img" src="${pageContext.servletContext.contextPath}/resources/assets/img/products/furniture/2.jpg"
                                                        alt="product-img">
                                                </a>
                                    ...
                                    <div class="col-lg-4 col-md-6 col-6" data-aos="fade-up" data-aos-duration="700">
                                        <div class="product-card">
                                            <div class="product-card-img">
                                                <a class="hover-switch" href="collection-left-sidebar.html">
                                                    <img class="secondary-img"
                                                        src="${pageContext.servletContext.contextPath}/resources/assets/img/products/furniture/11.jpg" alt="product-img">
                                                    <img class="primary-img" src="${pageContext.servletContext.contextPath}/resources/assets/img/products/furniture/3.jpg"
                                                        alt="product-img">
                                                </a>
                                    ...
                                    <div class="col-lg-4 col-md-6 col-6" data-aos="fade-up" data-aos-duration="700">
                                        <div class="product-card">
                                            <div class="product-card-img">
                                                <a class="hover-switch" href="collection-left-sidebar.html">
                                                    <img class="secondary-img"
                                                        src="${pageContext.servletContext.contextPath}/resources/assets/img/products/furniture/15.jpg" alt="product-img">
                                                    <img class="primary-img" src="${pageContext.servletContext.contextPath}/resources/assets/img/products/furniture/5.jpg"
                                                        alt="product-img">
                                                </a>
                                    ...
                                    <div class="col-lg-4 col-md-6 col-6" data-aos="fade-up" data-aos-duration="700">
                                        <div class="product-card">
                                            <div class="product-card-img">
                                                <a class="hover-switch" href="collection-left-sidebar.html">
                                                    <img class="secondary-img"
                                                        src="${pageContext.servletContext.contextPath}/resources/assets/img/products/furniture/16.jpg" alt="product-img">
                                                    <img class="primary-img" src="${pageContext.servletContext.contextPath}/resources/assets/img/products/furniture/6.jpg"
                                                        alt="product-img">
                                                </a>
                                    ...
                                    <div class="col-lg-4 col-md-6 col-6" data-aos="fade-up" data-aos-duration="700">
                                        <div class="product-card">
                                            <div class="product-card-img">
                                                <a class="hover-switch" href="collection-left-sidebar.html">
                                                    <img class="secondary-img"
                                                        src="${pageContext.servletContext.contextPath}/resources/assets/img/products/furniture/17.jpg" alt="product-img">
                                                    <img class="primary-img" src="${pageContext.servletContext.contextPath}/resources/assets/img/products/furniture/7.jpg"
                                                        alt="product-img">
                                                </a>
                                    ...
                                    <div class="col-lg-4 col-md-6 col-6" data-aos="fade-up" data-aos-duration="700">
                                        <div class="product-card">
                                            <div class="product-card-img">
                                                <a class="hover-switch" href="collection-left-sidebar.html">
                                                    <img class="secondary-img"
                                                        src="${pageContext.servletContext.contextPath}/resources/assets/img/products/furniture/19.jpg" alt="product-img">
                                                    <img class="primary-img" src="${pageContext.servletContext.contextPath}/resources/assets/img/products/furniture/8.jpg"
                                                        alt="product-img">
                                                </a>
