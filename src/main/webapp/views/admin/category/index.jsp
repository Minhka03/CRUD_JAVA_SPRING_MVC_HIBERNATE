			...
			<div class="layout-page">
				...
				<div class="container mt-5">
					<div class="add d-flex justify-content-between">
						<form action="category" class="d-flex">
					...
					<table class="table table-bordered mt-5 mb-5 ">
						<tr>
							<td class="vertical-align-middle text-center">Id</td>
							<td class="vertical-align-middle text-center">Tên</td>
							<td class="vertical-align-middle text-center">Trạng thái</td>
							<td class="vertical-align-middle text-center"></td>

						</tr>
						<c:forEach items="${listPage}" var="c">
							<tr>
								<td class="vertical-align-middle text-center">${c.categoryId}</td>
